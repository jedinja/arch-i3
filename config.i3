...
bindsym $mod2+t exec jetbrains-toolbox

### Screen Shots ###
####################

bindsym $mod2+SHIFT+4 exec scrot -u "/mnt/storage2/screenshots/$(date)".jpg

### Language support ###
########################

bindsym $mod2+SHIFT+0 exec setxkbmap -layout us
bindsym $mod2+SHIFT+9 exec setxkbmap -layout bg -variant bas_phonetic
...
#bindsym $mod2+k focus down
#bindsym $mod2+l focus up
#bindsym $mod2+semicolon focus right
...
## Enable second monitor on startup
#exec --no-startup-id xrandr --output eDP-1-1 --auto --left-of HDMI-0

### Use a script to screenshot, pixelize and lock the screen ###
################################################################

bindsym $mod2+l exec "~/.lock-screen.sh"
#exec xautolock -time 1 -locker '~/.lock-screen.sh' &
